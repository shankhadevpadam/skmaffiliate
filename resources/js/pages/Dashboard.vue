            ...
            <div class="grid auto-rows-min gap-4 md:grid-cols-4">
                ...
                >
                    ...
                    <div class="mt-5 flex items-end justify-between">
                        ...
                        <span
                            class="bg-success-50 text-success-600 flex items-center gap-1 rounded-full py-0.5 pr-2.5 pl-2 text-sm font-medium"
                        >
                            <svg
                                class="fill-current"
                                width="12"
                ...
                >
                    ...
                    <div class="mt-5 flex items-end justify-between">
                        ...
                        <span
                            class="bg-error-50 text-error-600 flex items-center gap-1 rounded-full py-0.5 pr-2.5 pl-2 text-sm font-medium"
                        >
                            <svg
                                class="fill-current"
                                width="12"
